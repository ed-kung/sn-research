...
The views expressed in this paper are solely those of the authors and do not necessarily reflect the views of Stacker News. Stacker News provided the data, but did not exercise editorial control over the content of this paper, nor over the analysis, interpretation, or reporting of the results. All errors are those of the authors. All computer code used for the analysis is open source and available at \url{https://github.com/ed-kung/sn-research}.
}
}
